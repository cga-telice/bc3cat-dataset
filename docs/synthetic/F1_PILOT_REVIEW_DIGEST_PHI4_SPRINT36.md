# Review Digest — OEB070$ (phi4:latest, Sprint 36: + template_paraphrase, seed 7)

47 distinct variants (representative leaf per variant chosen to exhibit each modification's condition).
...
## 42. single_L3_template_paraphrase_2dc1e93232
- **item_key:** `OEB070aaaa`  (modifications: 1)
- template_paraphrase: '\\Suministro y ejecución de canalización de $A tubo(s) de polietileno 110 mm 5 At. con topo bajo vías. Trabajo: $B Banda de mantenimiento: $C Condiciones de ejecución: $D' → 'Provisión y colocación de $A conducto(s) de polietileno de diámetro nominal 110 mm 5 At. con topo bajo vías. Labor: $B Zona de mantenimiento: $C Circunstancias de ejecución: $D'
- **resumen:** Suministro y ejecución de canalización de 1 tubo(s) de polietileno 110 mm 5 At. con topo bajo vías (Diurno/i >==5 horas/Volumen relevante)
- **texto:** Provisión y colocación de 1 conducto(s) de polietileno de diámetro nominal 110 mm 5 At. con topo bajo vías. Labor: Diurno Zona de mantenimiento:  i >= 5 horas Circunstancias de ejecución: Volumen relevante

## 43. single_L3_template_paraphrase_84d940edaf
- **item_key:** `OEB070aaaa`  (modifications: 1)
- template_paraphrase: 'Suministro y ejecución de canalización de $A tubo(s) de polietileno 110 mm 5 At. con topo bajo vías ($L(%B)/$M(%C)/$N(%D))' → 'Provisión y colocación de $A conducto(s) de polietileno de diámetro nominal 110 mm 5 At. con topo bajo vías ($L(%B)/$M(%C)/$N(%D))'
